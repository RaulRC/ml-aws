...
# Fetch data
mkdir data
aws s3 cp s3://poc-ml-op/data/iris.data data/terrorism.csv --region eu-west-1
...
# Write output
aws s3 cp output.txt s3://poc-ml-op/resources/output_terror.txt --region eu-west-1
# Terminate instance
